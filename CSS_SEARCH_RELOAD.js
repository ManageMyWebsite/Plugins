...
$(targetNode).find('.sqs-custom-css-content .code-editor').prepend('<div id="reloadme" style="padding: 10px; border: solid 2px; text-align: center; cursor: pointer;">RELOAD FRAME</div>')
         $(targetNode).find('#reloadme').click(function(){
          console.log(window.parent.document, window.parent.document.getElementById('sqs-site-frame'))
           window.parent.document.getElementById('sqs-site-frame').contentDocument.location.reload(true);
         })
